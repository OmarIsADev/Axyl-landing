export default function Card({ children, title, description, bg }) {
  return (
    <div style={{ "backgroundColor": bg}} className={`relative flex h-[356px] w-full flex-col items-start gap-2.5 overflow-hidden rounded-3xl border border-[var(--border)] p-9`}>
